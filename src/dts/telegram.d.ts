...
interface WebApp {
    ...
    /**
     * An object for controlling local storage
     */
...
type callbackFn = (error: string|null, value?: string|null) => void;

interface DeviceStorage {
    getItem(key: string, fn: (error: string|null, value?: string|null) => void): DeviceStorage;
    setItem(key: string, value: string, fn: (error: string|null, value?: boolean) => void): DeviceStorage;
    removeItem(key: string, fn: (error: string|null, value?: string|null) => void): DeviceStorage;
    clear(fn: (error: string|null, value?: string|null) => void): DeviceStorage;
}